...
res.render('index', { title: 'Easter Basket App', user : req.user });
});
router.get('/register', function(req, res) {
res.render('register', { title: 'Easter Basket App Registration'});
});
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'Easter Basket App Login', user : req.user });
  });
